            ...
            <div className="w-screen flex-col h-screen flex justify-center bg-[#05070A] items-center">
              ...
              Inventory Management System
                ...
                <div className="flex flex-col justify-center items-center w-full h-11/12 text-center px-4">
                    <h1 data-aos="fade-right" className="text-6xl md:text-8xl text-amber-50 font-bold mb-6 animate-pign">
                        Inventory Management System
                    </h1>
                    <p data-aos="fade-left" className="text-gray-300 mb-10 max-w-3xl text-2xl md:text-3xl">
